...
const QuotationPDFView = ({ quotation }) => {
  ...
  return (
    ...
    >
      ...
      <div className="pdf-top-section" style={{ display: 'flex', marginBottom: '10px' }}>
        {/* Left: Logo */}
        <div className="pdf-logo" style={{ marginRight: '10px', flexShrink: 0 }}>
          <img
            src="/canary-logo.png"
            alt="Canary Enterprise Logo"
            style={{
              height: '80px',
              width: 'auto',
              display: 'block'
        ...
        {/* Vertical Lines */}
        <div className="pdf-vertical-lines" style={{ width: '2px', backgroundColor: '#000', marginRight: '5px' }}></div>
        <div style={{ width: '2px', backgroundColor: '#FFD700', marginRight: '10px' }}></div>

        {/* Right: Contact Info Icons */}
        <div className="pdf-contact-info" style={{ flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ marginRight: '5px' }}>📞</span>
            <span>(+91) 8347 123704</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ marginRight: '5px' }}>✉️</span>
            <span>canaryenterprise@yahoo.com</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ marginRight: '5px' }}>📍</span>
            <span>57, R.R. Park Society, Harni Road, Vadodara-390022, Gujarat, India.</span>
          </div>
          <div style={{ borderBottom: '1px solid #000', width: '100%', marginBottom: '8px' }}></div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            {/* <span style={{ marginRight: '5px' }}>🏷️</span> */}
            <span style={{ fontWeight: 'bold' }}>GST. 24B0GPG5365H1ZZ</span>
          </div>
        </div>

        {/* Invoice Header */}
        <div className="pdf-invoice-header" style={{ textAlign: 'right', marginLeft: '20px' }}>
      ...
      <div className="pdf-footer" style={{
        ...
        {/* Right: Payment Info */}
        <div className="pdf-footer-right" style={{ width: '50%', paddingLeft: '10px' }}>
          <div style={{ fontWeight: 'bold', marginBottom: '5px' }}>Payment Info.</div>
          <div>A/C NAME : CANARY ENTERPRISE</div>
          <div>A/C NUMBER : 50200064634491</div>
          <div>IFSC CODE : HDFC0000147</div>
          <div>BANK : HDFC BANK LTD</div>
          <div>BRANCH : Baroda- Karelibaug</div>

          {/* Proprietor and Signature */}
          <div className="pdf-proprietor-section" style={{ marginTop: '30px', textAlign: 'right' }}>
            <div style={{ color: '#0066cc', fontWeight: 'bold' }}>CANARY ENTERPRISE</div>
            {/* Replaced text signature with image */}
            <div className="pdf-signature-container" style={{ textAlign: 'center', margin: '10px 0', marginLeft: '200px' }}>
              <img
                src="/signature.png"
